...
export default {
    getEmployee: async (token: string, id: number | string): Promise<any>  => { // very example
    ...
    getListedEmployees: async (token: string, page: PageRequest, pageNumber: number): Promise<any>  => {
    ...
    EmployeeOperate: async (token: string, operation: Operation): Promise<any>  => {
