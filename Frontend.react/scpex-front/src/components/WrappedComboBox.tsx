...
export default function WrappedComboBox({ enums, title, className, selectedIndex = 0,
    onChange = (o: Selectable, n: Selectable) => { }, getter, setter }: { enums: Selectable[], title?: string, className?: string, selectedIndex?: number, onChange?: Function | null | undefined, getter?: any, setter?: Function }) {
