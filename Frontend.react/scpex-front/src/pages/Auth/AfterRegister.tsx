...
export default function AfterRegister({ newUser }: { newUser: Trader | null }) {
    ...
    return <>
        {
            newUser && (
                <div className="grid grid-cols-1 gap-3">
                    ...
                    <Button className="text-2xl font-semibold py-1.5 w-full pb-2 bg-slate-600/90 hover:bg-slate-600 text-slate-50" onClick={() => window.navigator.clipboard.writeText(newUser.passwd!)}>
                        {newUser.passwd}<span className="text-base block">(Click to Copy)</span>
                    </Button>
