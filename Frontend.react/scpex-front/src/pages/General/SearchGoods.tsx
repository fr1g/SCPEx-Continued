...
export default function SearchGoods(){
    const [results, setResults] = useState([] as ReactNode[]);
    ...
    function mockResults(){
        ...
        setResults(rs as ReactNode[]);
    }

    return <Paper>
        <div className="w-full h-full? grid grid-fill-paper items-center justify-items-center justify-center transition-all">
            <div id="wrapper-search-with-list" className="min-h-screen?w-full transition-all">
